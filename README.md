# moci-pricing OpenAPI Specification
[![Build Status](https://travis-ci.org/bhushankamath/Swagger-2.0-Sample.svg?branch=master)](https://travis-ci.org/bhushankamath/Swagger-2.0-Sample)
...
6. If you did everything correct, https://bhushankamath.github.io/Swagger-2.0-Sample/ will lead to your new docs
...
- Documentation(ReDoc): https://bhushankamath.github.io/Swagger-2.0-Sample/
- SwaggerUI: https://bhushankamath.github.io/Swagger-2.0-Sample/swagger-ui/
- Look full spec:
    + JSON https://bhushankamath.github.io/Swagger-2.0-Sample/swagger.json
    + YAML https://bhushankamath.github.io/Swagger-2.0-Sample/swagger.yaml
- Preview spec version for branch `[branch]`: https://bhushankamath.github.io/Swagger-2.0-Sample/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://bhushankamath.github.io/Swagger-2.0-Sample/ with url from the message: `Server started <url>`
